...
void reset()
{
  ...
  String[] files = {"ninghostt1.svg","ninghostt2.svg","ninghostt3.svg","ninghostt4.svg"};
  s.addAnimation(files,10);
  String[] files1 = {"ninghostt1.svg","ninghostt1.svg"};
  s.addAnimation(files1,10);
  String[] files2 = {"ninghostt5.svg"};
  s.addAnimation(files2,10);
  String[] files3 = {"ninghostt11.svg","ninghostt11.svg"};
  s.addAnimation(files3,10);
  String[] files777 = {"ninghostt11.svg","ninghostt11.svg","ninghostt11.svg"};
  s.addAnimation(files777,10);
  s.currentAni=0;
  ...
  String[] files16 = {"bg.svg","bg1.svg"};
  String[] files17 = {"bg.svg","bg1.svg"};
...
void deadScreen()
{
  ...
  text("R.I.P.",0,0);
  textSize(30);
  text("Press ANY key to RESPAWN",0,60);
  /*noStroke();
  fill(0);
